...
export default function CameraFeed() {
    ...
    return (
        <div className="camera-feed" id="cameraFeed" ref={containerRef}>
            ...
            <img
                ...
                onLoad={() => { setHasSignal(true); updateImgRect(); }}
                onError={() => setHasSignal(false)}
            />

            {/* Detection hit zones + hover cards */}
            {hasSignal && detections.map((det, i) => {
            ...
            {/* Crosshair overlay */}
            {hasSignal && <div className="camera-feed__crosshair camera-feed__crosshair--overlay" />}
